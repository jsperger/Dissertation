...
# Contextual Successive Rejection for DTR Estimation
...
# Structured Successive Rejection

```{r, child='200_proposal_two.Rmd'}
```


# Multi-level Inteventions with distinct Individual- and Group-level Randomizations

...
Propose to extend the successive rejection algorithm to the structured case by modifying the rejection criteria to include the potential information gain that an arm provides. 
...
TODO: Efficiency definition
TODO: Define a design
...
Gittins index \cite{gittins1979bandit, gittins2011multi}

Bayesian review \cite{shahriari2015taking}

You know what it is \cite{pukelsheim2006optimal}

Nonlinear response models \cite{fedorov2013optimal}

RAR in Clinical Trials \cite{atkinson2019randomised}

efficient algorithms \cite{harman2020randomized} and R package \cite{harman2019optimal}